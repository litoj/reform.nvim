...
---@field unknown? 'noop'|'definition'|'copy-default'|'copy-current'|'print-default'|'print-current' when nothing is matched
...
---@field handlers? {[1]:string,[2]:fun(uri:string,ev:reform.open_link.Event)}[] regex & matched link handler pairs, use defaults.handlers[] to pick and order the default handlers
